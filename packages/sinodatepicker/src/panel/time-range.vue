<template>
  <transition
    name="sino-zoom-in-top"
    @before-enter="panelCreated"
    @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      :style="{ width: width + 'px' }"
      class="sino-time-range-picker sino-picker-panel"
      :class="popperClass">
      <div class="sino-time-range-picker-content">
        <div class="sino-time-range-picker-cell">
          <div class="sino-time-range-picker-header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds }"
            class="sino-time-range-picker-body sino-time-panel-content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="sino-time-range-picker-cell">
          <div class="sino-time-range-picker-header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds }"
            class="sino-time-range-picker-body sino-time-panel-content">
            <time-spinner
      ...
      <div class="sino-time-panel-footer">
        <button
          type="button"
          class="sino-time-panel-btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="sino-time-panel-btn confirm"
          @click="handleConfirm()"
