<template>
    <sino-input
            class="sino-date-editor"
            :class="'sino-date-editor-' + type"
            ...
            ref="reference">
        <!--<i slot="icon"
           class="sino-input-icon iconfont "
           @click="handleClickIcon"
           :class="[showClose ? 'icon-error' : 'icon-rili1']"
           @mouseenter="handleMouseEnterIcon"
           @mouseleave="showClose = false"
           v-if="haveTrigger">
        </i>-->
        <i class="data-icon-error fr sino-input-icon iconfont sino-cuowu" @click="iconErrorClick" v-if="iconErrorShow && disabled === false"></i>
        <i class="sino-input-icon fr iconfont sino-rili1" @click="handleClickIcon"></i>
    </sino-input>
</template>
...
<script>
    ...
    export default {
        ...
        watch: {
            pickerVisible(val) {
                if (!val) this.dispatch('SinoFormItem', 'sino.form.blur');
            ...
            displayValue(val) {
                ...
                this.dispatch('SinoFormItem', 'sino.form.change');
                if(val && this.clearable || this.readonly || this.disabled){
                    this.iconErrorShow = true;
                }else{
                    this.iconErrorShow = false;
                }
            }
        },
        ...
        computed: {
            ...
            triggerClass() {
                return this.type.indexOf('time') !== -1 ? 'sino-icon-time' : 'sino-icon-date';
            },
