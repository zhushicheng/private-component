  ...
  <div class="el-table"
    ...
    <div
      ...
      <div :style="{ width: bodyWidth }" class="el-table__empty-block" v-if="data && data.length === 0">
        <img src="../../theme-style/img/table-empty.png" class="el-table__empty-img"/>
        <span class="el-table__empty-text"><slot name="empty">{{ emptyText || t('el.table.emptyText') }}</slot></span>
      </div>
      <div :style="{ width: bodyWidth }" class="el-table__empty-block" v-if="data === null || data === undefined">
        <img src="../../theme-style/img/table-null.png" class="el-table__empty-img"/>
        <span class="el-table__empty-text"><slot name="empty">请搜索您需要的内容,或 <span @click="viewAll">查看全部</span></slot></span>
      </div>
