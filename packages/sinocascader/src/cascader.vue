        ...
        <div :class="[prefixCls + '-rel']" @click="toggleOpen" ref="reference">
            ...
            <slot>
                <sino-input
                  ...
                  <i class="iconfont sino-cuowu" v-show="showCloseIcon" @click="clearSelect"></i>
                </sino-input>
                <div
...
<script>
    ...
    import sinoDropdown from '../../sinodropdown/index';
    import sinoCaspanel from './caspanel.vue';
    ...
    const prefixCls = 'sino-cascader';
    const selectPrefixCls = 'sino-select';

    export default {
      name: 'sinoCascader',
      mixins: [ Emitter, Locale ],
      components: {sinoCaspanel, sinoInput, sinoDropdown },
...
//                this.$broadcast('on-clear');
                this.broadcast('sinoCaspanel', 'on-clear');
                this.visible = true;
            },
            handleClose () {
                this.visible = false;
...
//                this.query = event.target.value;
            ...
            getValidData (data) {
                function deleteData (item) {
                    ...
                    if ('children' in new_item && new_item.children && new_item.children.length) {
