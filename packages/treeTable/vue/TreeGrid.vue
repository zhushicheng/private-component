<template>
  <sino-table
    ...
    style="width: 100%"
    :row-style="showTr">
    <sino-table-column v-for="(column, index) in columns" :key="column.dataIndex"
      :label="column.text">
    ...
    <sino-table-column label="操作" v-if="treeType === 'normal'" width="260">
      <template scope="scope">
...
<script>
  ...
  import SinoTable from "../../sinotable/src/table";
  import SinoTableColumn from "../../sinoTableColumn/index";
  import SinoButton from "../../sinobutton/src/index";

  export default {
    components: {
      SinoButton,
      SinoTable,SinoTableColumn},
    name: 'tree-grid',
    props: {
