  ...
  <transition name="el-zoom-in-top">
    <div class="el-table-filter" v-if="multiple" v-show="showPopper">
      <div class="el-table-filter__content">
        <sino-checkbox-group class="el-table-filter__checkbox-group" v-model="filteredValue">
          <sino-checkbox
            v-for="filter in filters"
            :key="filter.value"
            :label="filter.value">{{ filter.text }}</sino-checkbox>
        </sino-checkbox-group>
      </div>
...
<script type="text/babel">
  ...
  import { PopupManager } from 'sinoUI/src/utils/popup';
  ...
  import sinoCheckboxGroup from 'sinoUI/packages/sinocheckboxGroup';

  export default {
    name: 'sinoAutoTableFilterPanel',
