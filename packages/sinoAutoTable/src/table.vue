<template>
  <div class="el-table"
    :class="[{
      ...
      'el-table--hover-none': !stripe && border,
    ...
    <div class="el-table__header-wrapper" ref="headerWrapper" v-if="showHeader" v-show="data && data.length > 0">
      <table-header
        ref="tableHeader"
        :store="store"
        :layout="layout"
    ...
    <div
      ...
      <div :style="{ width: bodyWidth }" class="el-auto-table__empty-block" v-if="data && data.length === 0">
        <img src="../../theme-style/img/table-empty.png" class="el-auto-table__empty-img"/>
        <span class="el-auto-table__empty-text"><slot name="empty">{{ emptyText || t('el.table.emptyText') }}</slot></span>
      </div>
      <div :style="{ width: bodyWidth }" class="el-auto-table__empty-block" v-if="data === null || data === undefined">
        <img src="../../theme-style/img/table-null.png" class="el-auto-table__empty-img"/>
        <span class="el-auto-table__empty-text"><slot name="empty">请搜索您需要的内容,或 <span @click="viewAll">查看全部</span></slot></span>
      </div>
    ...
    <div class="el-table__fixed" ref="fixedWrapper"
      v-if="fixedColumns.length > 0" v-show="data && data.length > 0"
      :style="[
    ...
    <div class="el-table__fixed-right" ref="rightFixedWrapper"
      v-if="rightFixedColumns.length > 0" v-show="data && data.length > 0"
      :style="[
...
<script type="text/babel">
  ...
  import Migrating from 'sinoUI/src/mixins/migrating';
